...
@Component({
  ...
  styleUrls: ['./voucherform.component.css']
})
export class VoucherformComponent {
 ...
 hstandard =[
  ...
  voucher!: ElementRef;
    ...
    openPdf() {
    // const doc = new jsPDF();
    const doc: jsPDF = new jsPDF('p','mm',[1200,1250]);
    const specialElementHandlers = {
      '#voucher': function (element:any, renderer:any) {
        return true;
      }
    };
    
    const content = this.voucher.nativeElement;
    doc.html(content, {
      callback: (doc) => {
